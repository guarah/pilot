...
const ProductInfoTab = ({
  ...
  <Fragment>
    <CardContent>
      <CardSection>
        <CardSectionDoubleLineTitle
          title={t('settings.card.product.title.boleto')}
          icon={<IconBarCode height={16} width={16} />}
          subtitle={t('settings.card.product.subtitle.boleto')}
          collapsed={false}
          // onClick={
    ...
    <CardContent>
      <CardSection>
        <CardSectionDoubleLineTitle
          title={t('settings.card.product.title.subscriptions')}
          icon={<IconSubscriptions height={16} width={16} />}
          subtitle={t('settings.card.product.subtitle.subscriptions')}
          collapsed={false}
          // onClick={
          //   this.handleSectionTitleClick('personalInfoSectionCollapsed')
          // }
